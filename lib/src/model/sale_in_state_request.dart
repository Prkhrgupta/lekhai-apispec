...
part 'sale_in_state_request.g.dart';

/// SaleInStateRequest
///
/// Properties:
/// * [saleAccount] - Sale A/c (In-State) ledger ID
/// * [cgstPercentage] 
...
@BuiltValue()
abstract class SaleInStateRequest implements Built<SaleInStateRequest, SaleInStateRequestBuilder> {
  /// Sale A/c (In-State) ledger ID
  ...
  SaleInStateRequest._();

  factory SaleInStateRequest([void updates(SaleInStateRequestBuilder b)]) = _$SaleInStateRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SaleInStateRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SaleInStateRequest> get serializer => _$SaleInStateRequestSerializer();
}

class _$SaleInStateRequestSerializer implements PrimitiveSerializer<SaleInStateRequest> {
  @override
  final Iterable<Type> types = const [SaleInStateRequest, _$SaleInStateRequest];

  @override
  final String wireName = r'SaleInStateRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SaleInStateRequest object, {
  ...
  void _deserializeProperties(
    ...
    required SaleInStateRequestBuilder result,
  ...
  @override
  SaleInStateRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SaleInStateRequestBuilder();
