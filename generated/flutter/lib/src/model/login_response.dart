...
abstract class LoginResponse implements Built<LoginResponse, LoginResponseBuilder> {
  @BuiltValueField(wireName: r'shopMenu')
  BuiltList<ShopMenu>? get shopMenu;
...
class _$LoginResponseSerializer implements PrimitiveSerializer<LoginResponse> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.shopMenu != null) {
      yield r'shopMenu';
      yield serializers.serialize(
        object.shopMenu,
        specifiedType: const FullType(BuiltList, [FullType(ShopMenu)]),
      );
    }
      ...
      switch (key) {
        case r'shopMenu':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(ShopMenu)]),
          ) as BuiltList<ShopMenu>;
          result.shopMenu.replace(valueDes);
          break;
        case r'token':
          final valueDes = serializers.deserialize(
            value,
