...
part 'purchase_in_state_request.g.dart';

/// PurchaseInStateRequest
///
/// Properties:
/// * [purchaseAccount] - Purchase A/c (In-State) ledger ID
/// * [cgstPercentage] 
/// * [cgstAccount] - CGST ledger account ID
/// * [sgstPercentage] 
/// * [sgstAccount] - SGST ledger account ID
/// * [cessPercentage] 
/// * [cessAccount] - CESS ledger account ID
@BuiltValue()
abstract class PurchaseInStateRequest implements Built<PurchaseInStateRequest, PurchaseInStateRequestBuilder> {
  /// Purchase A/c (In-State) ledger ID
  ...
  PurchaseInStateRequest._();

  factory PurchaseInStateRequest([void updates(PurchaseInStateRequestBuilder b)]) = _$PurchaseInStateRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PurchaseInStateRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PurchaseInStateRequest> get serializer => _$PurchaseInStateRequestSerializer();
}

class _$PurchaseInStateRequestSerializer implements PrimitiveSerializer<PurchaseInStateRequest> {
  @override
  final Iterable<Type> types = const [PurchaseInStateRequest, _$PurchaseInStateRequest];

  @override
  final String wireName = r'PurchaseInStateRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PurchaseInStateRequest object, {
  ...
  void _deserializeProperties(
    ...
    required PurchaseInStateRequestBuilder result,
  ...
  @override
  PurchaseInStateRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PurchaseInStateRequestBuilder();
